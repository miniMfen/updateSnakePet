...
- **自我修复**：窗口被长时间遮挡后自动重建画面，挂机数天也不怕"消失"（已知缺陷见文末「已知问题」）。
...
| — | 看门狗重建窗口后窗口 z 序可能浮到最上层（本应始终沉底） | 重建瞬间可能短暂盖住其它窗口 |

## 📜 版本历史

见 [CHANGELOG.md](CHANGELOG.md)：v4 → v5 的全量升级记录、v5.1.x 的三轮体验反馈修复，以及 **v5.2.0（本次）** 的十条改动明细与合并核验。
